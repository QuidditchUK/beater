...
export const EVENT_WRITE = 'event:write';

export const SCOPE_VOLUNTEER_READ = 'scope-volunteer:read';
export const SCOPE_VOLUNTEER_WRITE = 'scope-volunteer:write';

export const SCOPE_EMT_READ = 'scope-emt:read';
export const SCOPE_EMT_WRITE = 'scope-emt:write';

export const SCOPE_ADMIN_READ = 'scope-admin:read';
export const SCOPE_ADMIN_WRITE = 'scope-admin:write';
