...
const allowList = process.env.NODE_ENV === 'production'
  ? ['https://quidditchuk.org', 'https://www.quidditchuk.org', 'https://chaser.quidditchuk.org', 'https://quidditchscheduler-staging.eu.auth0.com', 'https://chaser-60ahlp30j-quidditchuk.vercel.app']
  : ['http://localhost:3000'];
